...
class KorisniciController extends Controller
{
	...
	{
		$model=new Korisnici('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Korisnici']))
			$model->attributes=$_GET['Korisnici'];
	...
	{
		$model=Korisnici::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Korisnici $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='korisnici-form')
		{
