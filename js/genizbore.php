...
if($vrj>2){  // glavni IF
 ...
 if($dd==-1){
		echo "<div style='float:left:width:100%;margin-top:6px;margin-left:15px;'>";
			...
			echo "<div style='float:left;width:300px;margin-right:8px;margin-bottom:6px'><input type='text' class='tf' name='odgo_".$ptbr."_1'/></div>";
		echo "</div>";
		...
		echo "<div style='float:left:width:100%;margin-top:6px;margin-left:15px;'>";
			...
			echo "<div style='float:left;width:300px;margin-right:8px;margin-bottom:6px'><input type='text' class='tf' name='odgo_".$ptbr."_2'/></div>";
		echo "</div>";
		echo "<div style='float:left;width:100%;height:6px'>&nbsp;</div>";
		...
		echo "<div id='kutija_odgovor".$ptbr.$_POST["odg_id"]."' style='float:left:width:100%;margin-top:6px;margin-left:15px;'>";
			...
			echo "<div style='float:left;width:300px;margin-right:8px;margin-bottom:6px'><input type='text' class='tf' name='odgo_".$ptbr."_".($_POST["odg_id"]+2)."'/></div>";
			echo "<div style='float:right;width:40px;margin-left:4px;margin-bottom:6px'><input class='izbrodgovor' pitbr='".$ptbr."' oid='".$_POST["odg_id"]."' style='width:28px;height:28px' type='button' value='X'/></div>";
